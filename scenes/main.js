...
const levelConfig = {
  width: 20,
  height: 20,
  '$':[sprite('coin'), 'coin', scale(0.4), {timer:3}],
  ...
  '#':[sprite('mushroom'), scale(0.1),'mushroom', body(), {timer:10}],
  ...
  '!':[sprite('evil-blue-mushroom'),'dangerous',{dir: -1}, scale(0.3), solid(), body()],
...
const level = add([
  text('level ' + parseInt(levelIndex + 1)), pos(30, 30)])
